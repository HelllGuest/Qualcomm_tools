...
#  $Header: //components/rel/boot.bf/2.2.C5/boot_images/core/storage/tools/ptool/ptool.py#1 $
#  $DateTime: 2014/11/03 23:05:07 $ 
#  $Author: pwbldsvc $

# when          who     what, where, why 
# --------      ---     ------------------------------------------------------- 
# 2014-09-25    ah      New attributes requested for Chrome OS
